...
// product.routes.js is being grabbed and stored here as a const ProductRoutes
const ProductRoutes = require("./routes/product.routes");
// the ProductRoutes (i.e. const variable) is being passed via app to
// the product.routes.js module.exports = app => {...} so that we can
